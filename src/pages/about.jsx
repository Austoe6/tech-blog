...
const AboutPage = ({data, transition, location}) =>{
                    ...
                    <div className='about-profile__container'>
                        <div>
                            <div className="about-page__image">
                                <img src={profileData.image} alt="austin smiling"/>
                            </div>
                        </div>
                        <div>
                            <div className="about-page__profile">
                                <p>{profileData.names}</p>
                                <p>Follow me on <a href={profileData.twitter} target='_blank' rel="noopener noreferrer">twitter</a></p>
                            </div>
                        </div>
                    </div>
                </div>
